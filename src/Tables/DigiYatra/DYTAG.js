...
export default function DYTAG() {
  ...
  const handleConcatenate = (e) => {
    ...
    const concatenatedResult1 = `HC${newTagNumber}DGY${OemCodes[oem]}BI${LocationCodes[location]}`;
    const concatenatedResult2 = `HC${newTagNumber}DGYIDMF${LocationCodes[location]}`;
    setResult1(concatenatedResult1);
    setResult2(concatenatedResult2);
    navigate('/addDYasset', { state: { result1: concatenatedResult1, result2: concatenatedResult2 } });
        ...
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
          ...
          {isForm1Visible ? (
            ...
            <div>
              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <button type="button" className="btn btn-outline-primary" onClick={() => navigate('/addDYasset')}>
                  Go to Add DY Asset
                </button>
              </div>
            </div>
