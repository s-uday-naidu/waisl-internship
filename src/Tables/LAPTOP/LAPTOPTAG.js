...
export default function LAPTOPTAG() {
  ...
  const handleConcatenate = (e) => {
    ...
    const concatenatedResult1 = `HE${newTagNumber}EUS${OemCodes[oem]}LA${LocationCodes[location]}`;
    setResult1(concatenatedResult1);
    navigate('/addlaptop', { state: { result1: concatenatedResult1} });
        ...
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
          ...
          {isForm1Visible ? (
            ...
            <div>
              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <button type="button" className="btn btn-outline-primary" onClick={() => navigate('/addlaptop')}>
                  Go to Add laptop Asset
                </button>
              </div>
            </div>
          )}
